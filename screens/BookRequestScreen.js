    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <View style={{ flex: 0.9 }}>
          ...
          />
          {this.state.bookName==='other'?
        (<Input
          style={styles.formTextInput}
          label={"Other Book Name"}
          placeholder={"Other Book name"}
          containerStyle={{ marginTop: RFValue(60) }}
          onChangeText={
            (text) => {
              console.log(text)
          ...
          value={this.state.otherBookName}
        />)  
        :(undefined)
        }
          {this.state.showFlatlist ? (
            ...
            <View style={{ alignItems: "center" }}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  console.log("before"+this.state.bookName)
                  if(this.state.bookName==='other'){
                    console.log("obn "+this.state.otherBookName)
                    this.addRequest(
                      this.state.otherBookName,
